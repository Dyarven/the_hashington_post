...
<html lang='gl'>
    ...
    if (isset($_SESSION['username'])) {
        ...
        echo "
                <li class='login'><a href='./modusuario.php'>
    ...
    if (isset($_SESSION['user_type']) && ($_SESSION['user_type'] == 'administrador')) {
        ...
        <nav class='navegacion'>
            <ul class='menu'>
                <li><a href='../inicio_admin.php'>Novas</a></li>
                <li><a href='software.php'>Software</a>
                    <ul class='submenu'>
                        <li><a href='kali.php?so=kali'>Kali Linux</a></li>
                        <li><a href='blackarch.php?so=blackarch'>BlackArch Linux</a></li>
                    </ul>
                </li>
                <li><a href='conceptos_e_procedementos.php'>Conceptos e procedementos</a>
                </li>
