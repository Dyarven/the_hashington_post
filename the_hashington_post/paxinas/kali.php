...
if (isset($_SESSION['user_type']) && (($_SESSION['user_type'] == 'administrador') OR ($_SESSION['user_type'] == 'editor'))) {
    echo "
              <div class='botonconf_a'>
                  <b><a href='../scripts/editar_actualizacions.php?so=kali&accion=editar' class='botonconf_b'>Editar</a></b>
              </div>
              <div class='botonconf_a'>
                  <b><a href='../scripts/editar_actualizacions.php?so=kali&accion=insertar' class='botonconf_b'>Insertar</a></b>
              </div>";
}
?>
              <section>
                 <article class="art_completo2">
                     <h2 class="header_software"><image src="../imaxes/kalifondo.png" class="tituloimx"></image></h2>
                     <br/>
